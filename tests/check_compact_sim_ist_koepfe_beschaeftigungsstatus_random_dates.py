...
def main() -> None:
    ...
    for idx, target_date in enumerate(_random_dates(), start=1):
        ...
        _assert(missing_forecast == 0, f"{target_date:%d.%m.%Y}: Simulierte Zugaenge haben unbekannten Beschaeftigungsstatus.")
    ...
    print("")
    print("OK: Beschaeftigungsstatus-Checks fuer 4 zufaellige Zukunftsdaten erfolgreich.")
