...
def _run_single_check(
    *,
    ...
    _assert(breakdown_total == total_heads, f"Alterskohorten-Breakdown summiert sich nicht auf Gesamt-Koepfe fuer {target_date:%d.%m.%Y}.")
...
def main() -> None:
    ...
    print("OK: Alterskohorten-Checks fuer 4 zufaellige Zukunftsdaten erfolgreich.")
