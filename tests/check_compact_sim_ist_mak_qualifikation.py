...
def main() -> None:
    ...
    breakdown_df = compact.create_breakdown_table(emp_df, "Ausbildung", value_col)
    ...
    _assert(missing_education == 0, "Es gibt Mitarbeitende ohne Ausbildung; die MAK-Qualifikationsdarstellung waere unvollstaendig.")
    _assert(abs(breakdown_total - total_mak_raw) < 1e-6, "Qualifikations-Breakdown summiert sich nicht auf Gesamt-MAK roh.")

    print("OK: IST-Analyse > MAK > Qualifikation ist fuer 31.12.2026 konsistent.")
