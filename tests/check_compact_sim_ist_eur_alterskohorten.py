...
die EUR-Verteilung als auch die Altersfortschreibung identischer Personen.
"""
...
def main() -> None:
    ...
    shared = base_unique.merge(
        future_unique[["PersNr", "Alter_Jahre", "Alterskohorte", "Total_Cost_Year"]],
        on="PersNr",
    ...
    _assert("Total_Cost_Year" in future_unique.columns, "Spalte 'Total_Cost_Year' fehlt in der deduplizierten Mitarbeitersicht.")
    ...
    _assert(abs(breakdown_total - total_cost_raw) < 1e-6, "Alterskohorten-Breakdown summiert sich nicht auf Gesamt-EUR roh.")
    ...
    print("OK: IST-Analyse > EUR > Alterskohorten ist fuer 31.12.2026 konsistent.")
