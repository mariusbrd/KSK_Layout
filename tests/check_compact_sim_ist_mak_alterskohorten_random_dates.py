...
def _run_single_check(
    *,
    ...
    _assert(abs(breakdown_total - total_mak_raw) < 1e-6, f"Alterskohorten-Breakdown summiert sich nicht auf Gesamt-MAK roh fuer {target_date:%d.%m.%Y}.")
...
def main() -> None:
    ...
    print("OK: MAK-Alterskohorten-Checks fuer 4 zufaellige Zukunftsdaten erfolgreich.")
