...
def create_combined_snapshot(
    ...
    """
    Kombiniert die 4 Dateien zu einem Snapshot.
    
    KORRIGIERT: Verwendet stichtagsbezogenen ATZ-Merge ohne Duplikate.
    """
    if stichtag is None:
    ...
    # Standardisierung: Personalnummern
    ...
    # KORRIGIERT: ATZ-Merge ohne Duplikate (nur aktuelle Phase)
    atz_aktuell = atz[
        (atz['Beginn'] <= stichtag) & 
        (atz['Ende'] >= stichtag)
    ].copy()
